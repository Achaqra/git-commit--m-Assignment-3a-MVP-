...
export default async function CheckoutPage({
  ...
  const quantity = 1;
  const inputClassName = "w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-zinc-900 placeholder:text-zinc-400";
    ...
    <div className="mx-auto w-full max-w-[1100px] px-4 py-6 sm:px-6 lg:px-8">
      ...
      <section className="mt-6 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-4">
          ...
          <form action={placeOrder} id="checkout-form" className="rounded-2xl border border-zinc-800/10 bg-white/90 p-5 shadow-sm">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              ...
              <label className="space-y-1 text-sm text-zinc-700 sm:col-span-1">
                ...
                <input autoComplete="given-name" className={inputClassName} defaultValue="Alex" name="shipping_first_name" required />
              </label>
              <label className="space-y-1 text-sm text-zinc-700 sm:col-span-1">
                <span>Last name</span>
                <input autoComplete="family-name" className={inputClassName} defaultValue="Walker" name="shipping_last_name" required />
              </label>
              ...
              <label className="space-y-1 text-sm text-zinc-700 sm:col-span-1">
                <span>City</span>
                <input autoComplete="address-level2" className={inputClassName} defaultValue="Berlin" name="shipping_city" required />
              </label>
              <label className="space-y-1 text-sm text-zinc-700 sm:col-span-1">
                <span>Postal code</span>
                <input autoComplete="postal-code" className={inputClassName} defaultValue="10115" name="shipping_postal_code" required />
              </label>
              <label className="space-y-1 text-sm text-zinc-700 sm:col-span-1">
                <span>Email</span>
                <input autoComplete="email" className={inputClassName} defaultValue="alex@superiorfits.com" name="shipping_email" required type="email" />
              </label>
              <label className="space-y-1 text-sm text-zinc-700 sm:col-span-1">
                <span>Country</span>
                <input autoComplete="country" className={inputClassName} defaultValue="DE" name="shipping_country" required />
              </label>
              ...
              <label className="space-y-1 text-sm text-zinc-700 sm:col-span-1">
                <span>Expiry</span>
                <input autoComplete="cc-exp" className={inputClassName} defaultValue="12/28" name="payment_expiry" required />
              </label>
              <label className="space-y-1 text-sm text-zinc-700 sm:col-span-1">
                <span>CVC</span>
                <input autoComplete="cc-csc" className={inputClassName} defaultValue="123" name="payment_cvc" required />
              </label>
            </div>
          </form>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-zinc-800/10 bg-white/90 p-5 text-sm text-zinc-700 shadow-sm">
            <h2 className="text-sm font-semibold uppercase tracking-[0.2em] text-zinc-700">Need to adjust?</h2>
            <div className="mt-3 flex flex-wrap gap-2">
              <Link
                className="inline-flex items-center rounded-lg border border-zinc-300 px-4 py-2 text-sm font-medium transition hover:bg-zinc-100"
